...
- [x] B1 (`345dc0b9`) — Content + engine (TT3/TT4): `balance/testdata/typer-v1.json` fixture (placeholder
...
- [ ] B7 — PARTIAL (`a3c87149`, `9e82a7f0`: AC9, AC11, AC8 service-level half) — Composed platform path (real Postgres): create → begin → submits → terminal → faucet →
