# Copy Pipeline Foundation implementation plan

RFC: `rfc/copy-pipeline-foundation.md`

- [x] Acceptance review complete; C1-C10 owner rulings reconciled into the RFC.
- [x] Land the strict copy source grammar, reference/provenance registries, seed copy, deterministic generator, and copy identity.
