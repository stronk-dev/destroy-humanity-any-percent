...
| Account, rights and privacy | Backend security/deletion tests exist; player recovery/export/delete and retention disclosure do not. The current 60-table/non-DB inventory, a ten-table SQL-column tranche and cold Postgres deletion evidence distinguish removed credentials from retained Founder/save/intent history and a permanent account-linked bootstrap tombstone. Nested JSON, 50 tables and non-DB fields remain unclassified. | Owner/legal D-008/D-009/D-015 decisions, remaining field/payload disposition, accepted Account/UI/retention contracts, R-003 on the actual workflow. |
