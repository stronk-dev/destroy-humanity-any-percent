...
| Account, rights and privacy | Backend security/deletion tests exist; player recovery/export/delete and retention disclosure do not. The current 60-table/non-DB inventory and 24-table SQL-column maps distinguish removed credentials from retained Founder/save/intent, immutable archive, board and dead-letter history. Cold Account, archive and board witnesses pass separately; no populated-board deletion witness exists. Nested payloads, 36 tables and non-DB fields remain unclassified. | Owner/legal D-008/D-009/D-015 decisions, remaining field/payload disposition and joined rights witness, accepted Account/UI/retention contracts, R-003 on the actual workflow. |
