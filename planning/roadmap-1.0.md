...
| Account, rights and privacy | Backend security/deletion tests exist; player recovery/export/delete and retention disclosure do not. The 60-table/non-DB inventory and 40-table SQL-column maps distinguish removed credentials from retained Founder/save/intent, archive, boards and shared Route/Commons records. Cold component witnesses pass separately; populated-board deletion remains untested, and source trace shows archived Founders can remain counted in Commons health (RP-119). Nested payloads, 20 tables and non-DB fields remain unclassified. | Owner/legal D-008/D-009/D-015 decisions, remaining field/payload disposition and joined rights/Commons witnesses, accepted Account/UI/retention contracts, R-003 on the actual workflow. |
...
3. Bring the source-traced [`Phase-0 exact-manifest proposal`](platform-alignment/phase0-manifest-proposal.md)
   ...
   Finish the remaining Guild/Minigame/Soul/Transport and payload/non-DB rights inventory, then
