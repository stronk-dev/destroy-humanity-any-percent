...
| 2 | **READY — record reconciliation** | Permits/FCE, Prestige, Leaderboards, Minigame Platform, Account, Transport, CI, API, Game UI, and Minigame API/Surface passes complete with RP-027–RP-071 filed. Continue Combat Shared against current tests and exact review ranges. | Each checkbox is proven, remains open with a named blocker, or is split to a successor; no archival without range-union and designated verdict. |
...
| 6 | **BLOCKED on account-body reconciliation plus D-005/D-008/D-009** | Draft account refresh/recovery/export/deletion/offline-fallback successor, including RP-048's 15-minute expiry path. | The adopted server-default/local-fallback model and owner choices are represented exactly; rotation/reconnect and R-003 acceptance are embedded. |
