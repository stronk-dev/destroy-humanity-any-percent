...
| 2 | **READY — record reconciliation** | Permits/FCE, Prestige, Leaderboards, and Minigame Platform passes complete with RP-027–RP-047 filed. Continue Account, Transport, and CI plans against current tests and exact review ranges. | Each checkbox is proven, remains open with a named blocker, or is split to a successor; no archival without range-union and designated verdict. |
...
| 6 | **BLOCKED on account-body reconciliation plus D-005/D-008/D-009** | Draft account recovery/export/deletion/offline-fallback successor. | The adopted server-default/local-fallback model and owner choices are represented exactly; R-003 acceptance is embedded. |
