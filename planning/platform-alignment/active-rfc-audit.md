...
| Leaderboards & Balance Epochs | implementing | Epoch/replay/projection mechanics are cold-green. Body/docs match the six-verdict/five-category backend and route absent integration to an unaccepted draft successor. AC1/AC5/AC6 are mutation-proven; AC3 lacks its composed crossing witness; no runtime reader/client exists; plan evidence and review provenance remain stale. | RP-040–RP-043: finish AC3, accept/narrow the independent reader successor, reconcile plan/thread and obtain full-range cross-party review. |
