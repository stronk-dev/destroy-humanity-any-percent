...
| Leaderboards & Balance Epochs | implementing | Epoch/replay/projection mechanics are cold-green. Body/docs match the six-verdict/five-category backend and route absent integration to an unaccepted draft successor. AC5 any-membership is implemented and severing-proven; AC1/AC3/AC6 lack literal witnesses; no runtime reader/client exists; plan evidence and review provenance remain stale. | RP-040–RP-043: finish witnesses, accept/narrow the independent reader successor, reconcile plan/thread and obtain full-range cross-party review. |
