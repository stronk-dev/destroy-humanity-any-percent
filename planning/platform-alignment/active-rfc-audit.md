...
| Leaderboards & Balance Epochs | implementing | Body/docs and AC1/AC3/AC5/AC6 repair range are designated-approved at `440dbba`. No runtime reader/client exists, and the original implementation's full archival review union remains open. | RP-040/RP-043: accept/narrow the independent reader successor independently; obtain any broader historical archival verdict before archive. |
| Prestige & Exits | implementing | Body/docs, D-012 and AC2–AC6's repair range are designated-approved at `440dbba`; AC8 remains proven under governed availability. | RP-038 plus AC8 plan-evidence reconciliation: historical full-span review remains required before archival. |
