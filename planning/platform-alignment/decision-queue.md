...
| **D-005** | Choose the recoverability posture for the one-time recovery code: display/download/print, optional email, device-only risk, and loss disclosure. | Current runtime/threat trace; R-003 validates the later prototype rather than choosing the posture. | Account UX design and copy ruling. | Account UI, recovery, deletion/export workflow. |
...
| **D-012** | Include Advisor Mode in the chosen milestone with an exact player toggle/behavior contract, or explicitly defer it and reconcile Prestige's current claims. | Prestige lifecycle dossier plus D-001 accessibility/content floor. | `design/11`, Prestige ruling/body or successor RFC. | Prestige D5 and player accessibility surface. |
| **D-013** | Keep a composed async minigame lifecycle in current Minigame Platform acceptance, or move it explicitly to the first real async tenant successor. | Minigame lifecycle dossier and chosen milestone tenant set. | Minigame Platform ruling/body and roadmap. | Minigame AC1/AC6 closeout scope. |
...
| **D-016** | Choose gameplay telemetry posture: none, aggregate-only, or a larger disclosed set; separate it from operational metrics. | Milestone requirements, privacy/legal review, pacing/milestone measurement needs. | `design/00`, `design/02`, privacy/operations contract. | Community milestones, live balance calibration, honesty appendix. |
| **D-017** | Choose public UGC/social scope for the milestone: none, curated/guild-scoped phrases/names, or broader public feed. | D-001/D-007, compliance refresh, moderation staffing/operations constraints. | `design/05`, roadmap, ToS/moderation RFCs. | Feed/presence/guild surfaces and legal documents. |
