...
| Declarative content and copy | file/family/shipped-source boundary complete; 208-key consumption audit predeclared | All 91 balance and ten copy files plus 23 live/platform families now have exact boundaries, loaders, consumers, and gaps; `copy-key-consumption-plan.md` freezes the live/backend/fixture/ambiguous controls before row extraction. |
...
| Planning/docs/shared memory | file/thread boundary complete; author closeout repairs pending | All 23 planning threads, 38 docs, 213 tracked planning files, and 25 ignored planning files are classified; owner/ruling-author body fixes and archival moves remain routed, not inferred. |
