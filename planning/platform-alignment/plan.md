...
| Release and operations | deployment/package/config slice complete; rights/accessibility/retention remain | Build/package artifacts, dependency rights, provider requirements, secrets, deploy, backup/restore, rollback, monitoring, export/deletion, preservation. |
