...
| Play fully offline and import later | Account RFC and `design/06` | Import endpoint exists | No local save runtime | Production startup creates server account | No witness | **Claimed only** |
