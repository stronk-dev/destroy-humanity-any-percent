...
- [x] Resolve implementation blockers R9-R15 and reconcile the normative body/wire in the ruling
  edit.
- [x] Extend the authoritative harness with the ruled reference and beam policies.
- [x] Implement paired ablation runs, group attribution, exact report schema, and budget preflight.
