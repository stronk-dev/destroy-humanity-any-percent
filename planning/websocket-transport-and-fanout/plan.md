...
3. [x] Map committed production receipts/events into one transaction-owned, per-Founder ordered
   private-player outbox; snapshot recovery uses the authoritative full-state endpoint.
