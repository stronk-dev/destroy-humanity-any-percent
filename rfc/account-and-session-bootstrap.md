...
- **Design refs:** `design/06 §backend` (JWT accounts; anonymous play with local-only saves + upgrade path; data minimisation, no third parties; owner-aware save streams and the `New Founder` follow-up)
