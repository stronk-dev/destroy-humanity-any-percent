...
- **Planet Integrity:** one global scalar, **100% → 0, only ever decreasing**, driven by every player's harm and compute footprint. Rendered as landmass desaturation, receding ice, rising haze, night-side sprawl. **Mitigation decelerates the rate; it never reverses the level.**
