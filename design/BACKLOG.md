...
| RP-088 | Sunset research calls self-hosting an existing near-zero-cost deliverable, but no production bundle/client/export/bots-default/artifact/mirror/runbook exists. | ⚠ research-current-state contradiction -> D-003/R-006 |
