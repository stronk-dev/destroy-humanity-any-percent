...
| RP-118 | Account deletion and verification/board tests run separately; no cold joined witness deletes an account after populating verified runs, archived log and dead letters, so the exact retained post-delete outcome remains source-derived rather than executed. | ⚠ integrated rights-evidence gap -> D-009/D-015, later accepted Account/retention witness; `planning/platform-alignment/data-rights-fields-history-boards.md` |
