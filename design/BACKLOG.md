...
| RP-122 | Account deletion archives Founder mappings/save streams instead of deleting them; Minigame sessions/commands/receipts/faucet windows, Soul recovery sessions and Transport player outbox rows reference those retained entities, so their cascade FKs do not remove these rows on account deletion. No joined populated-family deletion witness or retention policy exists. | ⚠ source-derived data-rights boundary -> D-008/D-009/D-015 and accepted Account/retention successor; `planning/platform-alignment/data-rights-fields-final.md` |
