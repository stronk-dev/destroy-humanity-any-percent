...
export const GAME_UI_FACT_IDS = new Set(["bootstrap.needed", "feature.achievements", "feature.active_play", "feature.fiscal", "feature.meters", "feature.minigame.pitch", "feature.pets"]);
export const GAME_UI_SURFACES: readonly SurfaceRow[] = parseSurfaceRegistry(source, GAME_UI_FACT_IDS);
export type GameUISurfaceID = "achievements" | "desk" | "fiscal" | "meters" | "minigame_session" | "offer_sheet" | "run_end" | "settings" | "soul_recovery" | "vision_slide";
