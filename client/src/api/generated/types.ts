...
export type GameUICosmeticWearer = { pet_id: string; worn: string | null };

export type GameUICosmeticsArm = { active: boolean; items: Array<GameUICosmeticItem>; wearers: Array<GameUICosmeticWearer> };
...
export type GardenCurrentResponse = GardenActive | GardenInactive | GardenLocked;

export type GardenInactive = { kind: "inactive" };

export type GardenLocked = { kind: "locked"; unlock_id: string };

export type GardenPlot = { age_ticks: number; col: number; dormant: boolean; maturation_ticks: number; row: number; species_id: string; stage: "growing" | "mature" };

export type GardenView = { height: number; max_height: number; max_width: number; next_tick_wall_ms: number | null; pending_catchup_forfeited_ms: number; plots: Array<GardenPlot>; seed_collection: Array<string>; species_total: number; substrate_id: string; substrate_lockout_until_ms: number | null; tick_seq: number; width: number };
