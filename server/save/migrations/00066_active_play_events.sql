...
ALTER TABLE events ADD CONSTRAINT events_kind_check CHECK (kind IN (
    ...
    'guild_activity_evaluated', 'meter_band_changed.v1', 'achievement_earned.v1',
    'pet_care_applied.v1', 'pet_status_changed.v1',
    'minigame_resolved.v1', 'minigame_rating_changed.v1',
    'doctrine_picked', 'compute_credit_spent',
    'fiscal_period_harvested.v1', 'fiscal_credit_spent.v1',
    'opportunity_spawned.v1', 'opportunity_expired.v1', 'opportunity_claimed.v1',
    'buff_started.v1', 'buff_expired.v1'
));
