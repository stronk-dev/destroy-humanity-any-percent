...
ALTER TABLE commons_projection_events ADD CONSTRAINT commons_projection_events_kind_check
    CHECK (kind IN ('compact_signed', 'compact_tithe_raised', 'compact_left', 'compact_sampled'));

-- +goose Down
ALTER TABLE commons_projection_events DROP CONSTRAINT commons_projection_events_kind_check;
ALTER TABLE commons_projection_events ADD CONSTRAINT commons_projection_events_kind_check
    CHECK (kind IN ('compact_signed', 'compact_left', 'compact_sampled'));
