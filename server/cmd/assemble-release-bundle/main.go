...
func main() {
	...
	manifest, err := releasepackage.AssembleBundle(releasepackage.BundleInput{RepositoryRoot: *root, Output: *output,
		ServerBinary: *serverBinary, BackupBinary: *backupBinary, ReleaseBinary: *releaseBinary, GameserverImageArchive: *gameserverArchive, ClientDist: *clientDist, MetadataDirectory: *metadata,
