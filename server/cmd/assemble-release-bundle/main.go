...
func main() {
	...
	manifest, err := releasepackage.AssembleBundle(releasepackage.BundleInput{RepositoryRoot: *root, Output: *output,
		ServerBinary: *serverBinary, BackupBinary: *backupBinary, ReleaseBinary: *releaseBinary, OperationsBinary: *operationsBinary, GameserverImageArchive: *gameserverArchive, ClientDist: *clientDist, MetadataDirectory: *metadata,
