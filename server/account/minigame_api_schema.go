...
func APIErrorSchema() publicapi.NamedSchema {
	return publicapi.NamedSchema{Name: "APIError", Schema: apiObject(
		...
		apiField("detail", apiString("", "access_token", "account", "body", "bootstrap", "bootstrap_expired", "curriculum_exit_required", "cursor", "duplicate_card", "exclusive_activity", "fiscal_unlock_required", "founder", "founder_state", "game_ui_snapshot", "hack_slots_full", "hand_too_large", "human_content_locked", "illegal_phase", "insufficient_currency", "invalid_assist_level", "invalid_text", "ip", "limit", "line_too_long", "minigame_api", "minigame_command", "minigame_create", "minigame_revision", "minigame_session", "minigame_tenant", "public_api", "recovery_progress", "recovery_session", "recovery_token", "session_id", "soul_recovery_cancel", "soul_recovery_not_ready", "soul_recovery_progress", "soul_recovery_resolve", "soul_recovery_start", "tier_required", "unknown_card", "unknown_offer")),
	)}
}
...
func minigameErrorJSON(action string, status int) [][]byte {
	...
	case http.StatusConflict:
		...
		return exactAPIErrorJSON(
			...
			apiErrorPair{"not_eligible", "curriculum_exit_required"},
			...
			apiErrorPair{"not_eligible", "invalid_assist_level"},
			apiErrorPair{"not_eligible", "invalid_text"},
			apiErrorPair{"not_eligible", "line_too_long"},
			apiErrorPair{"not_eligible", "tier_required"},
